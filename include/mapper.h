...
# define PARSE_ERR_1 "Map content has alway to be the last in the \
.cub input file\n"
# define PARSE_ERR_2 "Map content can't be separated by a new line\n"
# define PARSE_ERR_3 "Unknown idenfifier found on input file\n"
# define MISS_INPUT_1 "There must be one and only one texture for each \
cardinal direction\n"
...
# define DOOR_ERR_1 "Door should have adjacent walls and adjacent walka\
ble positions\n"
...
void	read_and_validate_play_pos(t_scene **scene,
